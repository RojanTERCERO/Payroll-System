...
def number_to_words(number):                        
    # Implementation of number_to_words function
...
# Class definition for the PayrollSystem
class PayrollSystem():
    def __init__(self, root):
        ...
        # Frame for the main labels and date/time display
        ...
        # Frame and widgets for the Payroll Slip title and date/time
        ...
        tag1=Label(Label(label_4, text="Description", font=("minecraft", 10,"bold"), bg="#dae9dc", fg="black", anchor="n", padx=10).place(x=0, y=0,relwidth=1))
...
# Method to calculate net pay and update the display
    def calculate(self):
